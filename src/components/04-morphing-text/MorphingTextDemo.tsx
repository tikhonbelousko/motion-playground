...
import { useControls, LevaPanel, useCreateStore, folder } from "leva";
...
export function MorphingTextDemo() {
  ...
  // All controls using folder() for collapsed state
  const {
    wordFilterEnabled,
    enterBlurStart,
    enterThresholdStart,
      ...
      Colors: folder(
        {
          ...
          colorBackground: {
            value: DEFAULT_COLOR_BACKGROUND,
            label: "Background",
          },
        },
        { collapsed: true }
